...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        {/* Ensures the icon rotates when the accordion item is open */}
...
function AccordionContent({
  ...
  return (
    // 'data-[state=closed/open]' utility classes require the full class string to be present for Tailwind JIT to pick them up
