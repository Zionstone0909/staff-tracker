...
function BreadcrumbList({ className, ...props }: React.ComponentProps<'ol'>) {
  return (
    <ol
      ...
      // Combines base styles with custom classes for a horizontal list layout
      className={cn(
...
function BreadcrumbLink({
  ...
  // Use Slot if asChild is true, otherwise render an 'a' tag
...
function BreadcrumbPage({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      role="link" // Indicates that this span acts like a link
      aria-disabled="true" // Marks it as disabled or non-interactive
...
function BreadcrumbSeparator({
  ...
  return (
    <li
      ...
      role="presentation" // Hides the separator from screen readers
      aria-hidden="true"
      className={cn('[&>svg]:size-3.5', className)}
      {...props}
    >
      {/* Renders ChevronRight icon if no children are provided */}
